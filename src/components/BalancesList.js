...
import SendDialog, { addressfailed } from './SendDialog';
...
export default function BalancesList() {
  const addressfaileds = addressfailed();
  ...
  return (
    <Paper>
      ...
      />
        <h3>LIST NOT SUCCESS</h3>
          <textarea type="textarea" name="textValue" style={{width: '100%', height: '250px'}} value={addressfaileds}/>
    </Paper>
  );
}
